//BRXXTEST JOB 'BREXX VERIFICATION',CLASS=A,
...
//EXEC     DD   DSN=BREXX.{HLQ}.SAMPLES(&EXEC),DISP=SHR
//RXLIB    DD   DSN=BREXX.{HLQ}.RXLIB,DISP=SHR
//STDIN    DD   DUMMY
...
//BANNER   DD   DSN=BREXX.{HLQ}.SAMPLES(BANNER),DISP=SHR
