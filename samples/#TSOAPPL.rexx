...
UPDATE:
 CALL FSSFSET   '_TERMID', "CUU0C2"; CALL FSSCOLOR '_TERMID',#RED /* MARK AS DUMMY */
 CALL FSSFSET   '_SYSID' , "TK4-";   CALL FSSCOLOR '_SYSID' ,#RED /* MARK AS DUMMY */
...
INFO1:
 CALL FSSTEXT "Terminal",1,1,,#PROT+#BLUE; CALL FSSFIELD '_TERMID',1,11,8,#PROT+#BLUE
 CALL FSSTEXT "System"  ,2,1,,#PROT+#BLUE; CALL FSSFIELD '_SYSID' ,2,11,8,#PROT+#BLUE
 CALL FSSTEXT "TSO User",3,1,,#PROT+#BLUE; CALL FSSFIELD '_USRID' ,3,11,8,#PROT+#BLUE
RETURN
...
OPTION:
 CALL FSSTEXT "Option ===>",5,1,,#PROT+#GREEN; CALL FSSFIELD '_ZCMD',5,13,1,#TURQ
RETURN
