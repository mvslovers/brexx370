...
#define LA2E(t,f)   if (LTYPE(*(f))==LSTRING_TY)	La2e((t),(f))
#define LE2A(t,f)   if (LTYPE(*(f))==LSTRING_TY)	Le2a((t),(f))
...
void  __CDECL La2e    ( const PLstr to, const PLstr from);
void  __CDECL Le2a    ( const PLstr to, const PLstr from);
