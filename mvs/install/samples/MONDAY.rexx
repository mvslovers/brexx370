...
Say 'off shore, smashed upon some outcroping rocks, is the remains of your ';
SAY 'boat. You notice that the sun feels really hot today.';
RETURN;
ROOM7:;
...
Say 'sun creating a cool shade. The ground is blanketed with a varity of';
Say 'colored leaves. It is very peaceful here.';
RETURN;
ROOM9:;
...
Say 'of the four corners. The shed is mostly empty save a few usless items ';
Say 'that are scattered about. The door squeaks as it sways in the wind.';
RETURN;
ROOM23:;
...
SAY'spotted by a Coast Guard Vessel. You were brought on board, given clean';
SAY'clothes, fed a big meal, and then taken home! You parents were so glad to';
Say'see you alive that they forgot all about the new boat you wrecked!';
SAY;
